...
fun rememberProductDetailStrings() = ProductDetailStrings(
    ...
    reviewsSectionHeader = stringResource(R.string.reviews_section_header),
    emptyReviewsPlaceholder = stringResource(R.string.empty_reviews_placeholder),
    addReviewCardTitle = stringResource(R.string.add_review_card_title),
    addReviewNameLabel = stringResource(R.string.add_review_name_label),
    addReviewTitleLabel = stringResource(R.string.add_review_title_label),
    addReviewBodyLabel = stringResource(R.string.add_review_body_label),
    addReviewSubmitText = stringResource(R.string.add_review_submit_text),
    submitReviewSuccessMessage = stringResource(R.string.submit_review_success_message),
    submitReviewErrorMessage = stringResource(R.string.submit_review_error_message),
    addReviewNotLoggedInMessage = stringResource(R.string.add_review_not_logged_in_message),
    optionColor = stringResource(R.string.option_color),
    optionSize = stringResource(R.string.option_size),
    optionMaterial = stringResource(R.string.option_material),
)
...
data class ProductDetailStrings(
    ...
    val addReviewNotLoggedInMessage: String,
    val optionColor: String,
    val optionSize: String,
    val optionMaterial: String,
)